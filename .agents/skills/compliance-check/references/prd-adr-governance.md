...
**Blocking**: Yes — user-facing tasks without PRD, or architectural tasks without ADR, fail compliance.

## Purpose

Verifies that governance documents (PRDs and ADRs) were created/updated as part of
task delivery. These documents are the project's institutional memory — without them,
future tasks in the same feature area lack context.
...
| TRACK-*, EXC-* (tooling) | NO | Only if process decision |
