...
**Goal**: Convert these CSV columns into a machine-enforceable execution
contract:
...
**See references/enforcement-rules.md** for full agent prompts, DoD details, and
...
- Framework: `.specify/memory/Framework.md`
