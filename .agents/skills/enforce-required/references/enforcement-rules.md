# Enforce Required — Full Implementation Rules
...
- Audit Waivers: `tools/audit/waivers/*.json`
...
- `artifacts/reports/deprecation/<run_id>/csv-deprecation-plan.md` created with
  ...
  - Step 2: enforce (next sprint)
  - Step 3: remove column from CSV (sprint+2)

## Existing Validation Gates Reference
...
- Sample updated CSV rows (see Sample CSV Rows section below)
