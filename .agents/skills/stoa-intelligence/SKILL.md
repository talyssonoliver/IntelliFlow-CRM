...
description:
  Execute Intelligence STOA validation for AI/ML logic, LangChain/CrewAI chains,
  prompt engineering, embeddings, and AI safety guardrails.
---

# Intelligence STOA Sub-Agent

Validates AI/ML logic, chain correctness, prompt quality, model configuration,
...
**See references/gate-definitions.md** for full commands, log paths, AI-specific
validations, and execution code.
...
**Supporting STOA** by keywords: `prompt`, `agent`, `chain`, `embedding`,
`vector`, `scoring`, `llm`, `ollama`, `openai`, `langchain`, `crewai`, `model`,
`eval`

**Supporting STOA** by path: `apps/ai-worker/**`, `**/prompts/**`,
`**/chains/**`, `**/agents/**`, `**/embeddings/**`, `**/scoring/**`
...
**See references/gate-definitions.md** for full verdict JSON schema with
aiMetrics and execution code.
