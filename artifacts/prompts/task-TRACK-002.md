...
**Sprint:** 14
**Section:** Tracking
**Owner:** QA Lead + Frontend Dev (STOA-Quality)
**Status:** Backlog
...
**Dependency Status:**
- EXP-REPORTS-002 (DONE)
- IFC-088 (DONE)

### Pre-requisites
- [✓] FILE: `scripts/debt-analyzer.js`
- [✓] FILE: `scripts/sonarqube-metrics.js`

### Definition of Done
1. Dashboard shows debt trends, coverage %, SonarQube metrics
2. individual refresh buttons per metric type

### Artifacts to Track
- ARTIFACT:apps/project-tracker/components/tracking/QualityDashboard.tsx
- ARTIFACT:apps/project-tracker/app/api/tracking/quality/route.ts
- EVIDENCE:artifacts/attestations/TRACK-002/context_ack.json
