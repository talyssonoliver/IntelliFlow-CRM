...
### Pre-requisites
FILE:artifacts/sprint0/codex-run/Framework.md;FILE:audit-matrix.yml;ENV:OAuth callbacks;ENV:token exchange;FILE:apps/web/app/(auth)/login/page.tsx
...
### Artifacts to Track
- ARTIFACT:apps/web/app/(auth)/auth/callback/page.tsx
- ARTIFACT:apps/web/components/shared/oauth-callback.tsx
- ARTIFACT:apps/web/lib/shared/token-exchange.ts
- EVIDENCE:artifacts/attestations/PG-024/context_ack.json
