...
- ENV: Tailwind + shadcn/ui baseline present
...
2. includes light/dark theme rules, semantic color tokens, component states, and migration guidelines
3. produces a minimal theme reference" page spec"
4. targets: >=90%, zero errors
5. verified by: pnpm lint

### Artifacts to Track
- ARTIFACT:docs/design-system/token-mapping.md
- docs/design-system/theme-reference-spec.md
- docs/design-system/token-naming.md
- EVIDENCE:artifacts/attestations/BRAND-002/context_ack.json
