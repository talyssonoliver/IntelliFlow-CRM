...
**Current Sprint:** 14
**Sprint Progress:** 18/30 (60%)

### Recommended Actions

1. Ready to start: PG-030, PG-031, TRACK-004
...
- **IFC-067** ← blocked by: FILE:docs/api/contracts/api-contracts.yaml;IFC-095
- ... and 2 more
...
- **TRACK-006**: Build Health UI - Validation results build status test results
...
- ENV: Plan management
- ENV: upgrade/downgrade
- [✗] FILE: `apps/web/app/(billing)/billing/page.tsx`

### Definition of Done
1. Response <200ms, Lighthouse ≥90, plans managed
2. artifacts: page.tsx, subscription-manager.tsx, plan-changes.ts

### Artifacts to Track
- ARTIFACT:apps/web/app/(billing)/billing/subscriptions/page.tsx
- ARTIFACT:apps/web/components/billing/subscription-manager.tsx
- ARTIFACT:apps/web/lib/billing/plan-changes.ts
- EVIDENCE:artifacts/attestations/PG-030/context_ack.json
