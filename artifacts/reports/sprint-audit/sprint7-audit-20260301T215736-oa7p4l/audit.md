...
**Run ID:** `sprint7-audit-20260301T215736-oa7p4l`
**Generated:** 01/03/2026, 21:58:16
...
| Validations | 4 passed | 19 failed |
| KPIs | 0 met | 0 missed |
...
### 🔴 Critical
- **IFC-079**: Validation(s) failed: pnpm lint
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-080**: Validation(s) failed: pnpm lint
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-082**: Validation(s) failed: pnpm lint
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-092**: Validation(s) failed: pnpm --filter @intelliflow/api test --run
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-093**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
...
- **IFC-133**: Validation(s) failed: pnpm test
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-134**: Validation(s) failed: pnpm test
  - *Recommendation:* Fix failing validations before marking complete
...
- **IFC-082**: 2 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-092**: 4 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-093**: Found 1 placeholder(s) in task artifacts
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
- **IFC-093**: 4 DoD criteria unverified
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
...
- **IFC-148**: 9 DoD criteria unverified
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
- **PG-138**: Found 2 placeholder(s) in task artifacts
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
- **PG-138**: 10 DoD criteria unverified
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
- **PG-139**: Found 10 placeholder(s) in task artifacts
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
...
**Issues:**
- Found 10 placeholder(s) in task artifacts
- Validation(s) failed: pnpm test
- 9 DoD criteria unverified
...
- `apps\web\src\app\calendar\[id]\page.tsx:77` - EMPTY_FUNCTION: `() => {}...`
- `apps\web\src\app\calendar\[id]\page.tsx:81` - EMPTY_FUNCTION: `() => {}...`
- `apps\web\src\app\calendar\[id]\page.tsx:85` - EMPTY_FUNCTION: `() => {}...`
- `apps\web\src\app\calendar\[id]\page.tsx:89` - EMPTY_FUNCTION: `() => {}...`
- ... and 5 more
...
b6da1fe9179896bd62ce9ae608c257bc316991d106c7a4497a4bdd7325ca9f9f  apps/web/lib/tickets/sla-notifications.ts
...
7cf19bdae39dbf78bbbe0405909b2a805a2036fba0ed6803a86d41a1710bffeb  apps/api/src/modules/agent/conversation.router.ts
...
*Generated by sprint-completion-auditor at 2026-03-01T21:58:16.862Z*