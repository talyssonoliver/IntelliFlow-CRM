...
**Run ID:** `sprint15-audit-20260301T170323-cemfte`
...
|----------|-------|--------|
| Artifacts | 89 ✓ | 1 missing, 0 empty |
| Validations | 4 passed | 11 failed |
| KPIs | 0 met | 0 missed |
...
- **PG-159**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-160**: Missing or invalid artifacts: apps/web/src/app/insights/page.tsx
...
**Issues:**
- Missing or invalid artifacts: apps/web/src/app/insights/page.tsx
- Validation(s) failed: pnpm --filter @intelliflow/web test --run
- 4 DoD criteria unverified
...
- `apps/web/src/app/insights/page.tsx` (missing)
...
246eaae2565cce1f84e4709740aa406bcdb59cdb9270f80ca69f5dd1c0a8b635  apps/web/src/app/(developer)/docs/page.tsx
...
61c3915f32fb3e86c5403caa4f6c3192ca9a5e905581f47ecdfab43085e6155a  apps/web/src/components/insights/InsightsListPage.tsx
...
*Generated by sprint-completion-auditor at 2026-03-01T17:03:34.403Z*