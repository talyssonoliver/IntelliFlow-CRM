...
**Run ID:** `sprint1-audit-20260228T170720-luplaa`
**Generated:** 28/02/2026, 17:26:04
**Duration:** 1123.8 seconds
**Strict Mode:** No
...
|----------|-------|--------|
| Artifacts | 89 ✓ | 0 missing, 0 empty |
...
### 🔴 Critical
- **ENV-017-AI**: Validation(s) failed: pnpm test
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-003**: Validation(s) failed: pnpm test
  - *Recommendation:* Fix failing validations before marking complete
- **BRAND-002**: Validation(s) failed: pnpm lint
  - *Recommendation:* Fix failing validations before marking complete
- **SALES-001**: Validation(s) failed: pnpm lint
  - *Recommendation:* Fix failing validations before marking complete
- **GOV-001**: Validation(s) failed: pnpm lint
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-106**: Validation(s) failed: pnpm test
  - *Recommendation:* Fix failing validations before marking complete

### 🟠 High
- **ENV-017-AI**: 8 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-003**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **BRAND-002**: 8 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **SALES-001**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **GOV-001**: 8 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-106**: 7 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
...
- **ENV-018-AI**: Sprint Planning and Velocity Prediction...
  ...
  - KPIs: 0/5 met
- **IFC-001**: PHASE-001: Technical Architecture Spike - Modern Stack...
  - Artifacts: 14 verified
  - Validations: 0 passed
  - KPIs: 0/3 met
- **IFC-002**: PHASE-001: Domain Model Design (DDD)...
  - Artifacts: 6 verified
  - Validations: 0 passed
  - KPIs: 0/2 met
- **IFC-074**: PHASE-040: Full Stack Observability...
...
- **IFC-075**: IaC with Terraform...
  ...
  - Validations: 0 passed
  - KPIs: 0/2 met
- **IFC-119**: Define recurring backlog refinement, sprint planning, review...
  - Artifacts: 8 verified
  - Validations: 0 passed
  - KPIs: 0/3 met
- **IFC-135**: Create ADR pack for multi-tenancy; workflow engine choice; a...
...
932f233da09a1b8019d201d37ef699b59c74213ad578fa9e5372a2d9dfe1683b  .specify/sprints/sprint-1/attestations/ENV-017-AI/context_ack.json
...
4d1abd4677601ff2a1d490a47098fbeee715b43b34048a3e895b9f3d52549d16  .specify/sprints/sprint-1/attestations/ENV-018-AI/context_ack.json
...
13d2bb3c933f148d505c7c9ca664bcad75d6d94a3198b00083823da7f3907800  .specify/sprints/sprint-1/specifications/IFC-001-spec.md
6398a0400e4f08b4d81fa0a30389c62a15196ce317429fde68f62ad23689a252  .specify/sprints/sprint-1/planning/IFC-001-plan.md
...
22085408b8c8fc5e81e47704c0e57dbd9e19f447628c3b7e258d1fb44042e571  .specify/sprints/sprint-1/attestations/IFC-001/context_pack.md
57674bd80c8f7815e7656bf77ce8aaa49ff2b30fc8ae1adc81a4275fccea8abb  .specify/sprints/sprint-1/attestations/IFC-001/context_ack.json
...
dd6ef4211783f5489582c041a6ad4716156e8440a447f7c9843ae52e8a7245bf  .specify/sprints/sprint-1/attestations/IFC-002/context_ack.json
adb4dee0f29898222ebbc2e20729f613248dc239c32df245867a18993b93f7f1  apps/api/src/trpc.ts
...
69ba6094c34db1677d07253b05f7ddb690747ddc870f97dc6eb52d86fd2aa154  .specify/sprints/sprint-1/attestations/IFC-003/context_ack.json
...
fda3969caf854f7d7e2e227f3820ee06301c18321d4dd3989e59fc1c5d471017  packages/observability/package.json
...
e51e30a91be4294940e7bf2dadee2608cb2099efca862db7b484bfdf1d6fe39c  packages/observability/src/tracing.ts
26abc7e5422b81b4ceb047693d8dff7990fa491a08686391668f74b1f76ddab7  packages/observability/src/metrics.ts
...
740b66518249ca553a1710bb9bf05bd70a2b0e76c9e4d5d6a7ab1dfed938ffc8  .specify/sprints/sprint-1/attestations/IFC-074/context_ack.json
...
af50b92c98614e909eb710cbf68188e05abe7afa95c33fa6b50709e2cef92e87  .specify/sprints/sprint-1/attestations/IFC-075/context_ack.json
...
d83d33c64efcec04406919bdc12db5e9c948140713940a5cc328ec39eef7e025  .specify/sprints/sprint-1/attestations/BRAND-002/context_ack.json
...
d30aa649be8e9354bbcc6d2f0da8fee672913de04984b2c8616f44dcaf906186  .specify/sprints/sprint-1/attestations/SALES-001/context_ack.json
...
9037214aa2331ff7e9c2dfa33e8b8f158c8d93a0975dcef3c12579df09954172  .specify/sprints/sprint-1/attestations/GOV-001/context_ack.json
...
cecbc28cfa5b77989f786751bc79957d3793f43159f49043e85484edc4eacc2b  .specify/sprints/sprint-1/attestations/IFC-106/context_ack.json
...
b4438100740c27001d87cfc5dd6473a3d0ce004e857a87334fb4cb52b80c6715  .specify/sprints/sprint-1/attestations/IFC-119/context_ack.json
...
e6d95b8715ae2686b5dadc2da74f29807dc1997cc3831a3e3a0a39c56cd1072a  .specify/sprints/sprint-1/attestations/IFC-135/context_ack.json
```

---

*Generated by sprint-completion-auditor at 2026-02-28T17:26:04.489Z*