...
**Run ID:** `sprint15-audit-20260301T220036-qepgqz`
**Generated:** 01/03/2026, 22:00:48
...
|----------|-------|--------|
| Artifacts | 106 ✓ | 0 missing, 0 empty |
| Validations | 17 passed | 28 failed |
| KPIs | 0 met | 0 missed |
...
- **IFC-027**: Validation(s) failed: pnpm lint
  - *Recommendation:* Fix failing validations before marking complete
- **PG-032**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-033**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-034**: Validation(s) failed: pnpm test
  - *Recommendation:* Fix failing validations before marking complete
- **PG-035**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-036**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-037**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-038**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-039**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-040**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-041**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-042**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
...
- **PG-159**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-160**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-163**: Validation(s) failed: pnpm --filter @intelliflow/api test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-169**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-170**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-171**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **DOC-011**: Validation(s) failed: compliance-check dry-run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-179**: Validation(s) failed: pnpm test
  - *Recommendation:* Fix failing validations before marking complete
...
- **PG-039**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-040**: 5 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
...
- **PG-159**: 3 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-160**: 4 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-163**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-169**: 5 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-170**: 5 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-171**: 4 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **DOC-011**: 4 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-179**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
...
**Description:** View All AI Insights page - /insights route with getAllInsights endpoint pagination and filtering by insight type
**Status:** Completed
...
**Description:** Home page integration tests - test home.router endpoints against real database with seed data
**Status:** Completed
...
**Description:** Developer Guides Page
**Status:** Completed
...
**Description:** Architecture Docs Page
**Status:** Completed
...
**Description:** Press Release Detail Page - dynamic /press/[id] route for individual press releases linked from /press index page (content audit finding F-004)
**Status:** Completed
...
*Generated by sprint-completion-auditor at 2026-03-01T22:00:48.769Z*