...
**Run ID:** `sprint13-audit-20260301T215957-4mnetk`
**Generated:** 01/03/2026, 22:00:07
...
| Validations | 10 passed | 20 failed |
| KPIs | 0 met | 0 missed |
...
- **PG-016**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-017**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-018**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-019**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-020**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-021**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-022**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-023**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-024**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-104**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
...
- **PG-015**: 7 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-016**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-017**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-018**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-019**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-020**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-021**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-022**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-023**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-024**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-104**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
...
- **IFC-183**: 9 DoD criteria unverified
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
- **PG-140**: Found 1 placeholder(s) in task artifacts
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
...
e0160ca74ba22f13bcdcebab3b324d6e321f50f0281f6f64dbe57d864a883626  apps/web/src/components/shared/mfa-verification.tsx
...
*Generated by sprint-completion-auditor at 2026-03-01T22:00:07.881Z*