...
**Run ID:** `sprint7-audit-20260301T003132-4hmesw`
**Generated:** 01/03/2026, 00:31:39
...
| KPIs | 0 met | 0 missed |
| Placeholders (in task artifacts) | - | 28 found |
...
- **IFC-133**: 6 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-148**: Found 1 placeholder(s) in task artifacts
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
- **IFC-148**: 9 DoD criteria unverified
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
- **PG-138**: Found 4 placeholder(s) in task artifacts
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
- **PG-138**: 10 DoD criteria unverified
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
- **PG-139**: Found 18 placeholder(s) in task artifacts
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
...
**Placeholders Found:**
- `apps\web\src\components\cases\CaseList.tsx:392` - EMPTY_FUNCTION: `...id: 'sep-1', icon: '', label: '', onClick: () =...`
- `apps\web\src\components\cases\CaseList.tsx:483` - EMPTY_FUNCTION: `onChange: () => {}, // Defensive fallback: assigne...`
- `apps\web\src\components\cases\CaseList.tsx:392` - EMPTY_FUNCTION: `() => {}...`
- `apps\web\src\components\cases\CaseList.tsx:483` - EMPTY_FUNCTION: `() => {}...`
...
**Issues:**
- Found 18 placeholder(s) in task artifacts
- Validation(s) failed: pnpm test
- 9 DoD criteria unverified
...
**Placeholders Found:**
- `apps\web\src\app\calendar\[id]\page.tsx:77` - EMPTY_FUNCTION: `}) ?? { mutateAsync: async () => {} };...`
- `apps\web\src\app\calendar\[id]\page.tsx:81` - EMPTY_FUNCTION: `}) ?? { mutateAsync: async () => {} };...`
- `apps\web\src\app\calendar\[id]\page.tsx:85` - EMPTY_FUNCTION: `}) ?? { mutateAsync: async () => {} };...`
- `apps\web\src\app\calendar\[id]\page.tsx:89` - EMPTY_FUNCTION: `}) ?? { mutateAsync: async () => {} };...`
- `apps\web\src\app\calendar\[id]\page.tsx:93` - EMPTY_FUNCTION: `}) ?? { mutateAsync: async () => {} };...`
- ... and 13 more
...
5e2919fbfe56890339a595052dc14aeaad19f234c4af7ab7303ef9cddf32bfb1  packages/application/src/services/ConversationSearchService.ts
...
e06212f0dbf3b1c204ca66bbb1d53a7618692e5cd73aa2db26697ec037c3468d  apps/web/src/app/calendar/(list)/page.tsx
...
b25ce4d1d962010ebd45cbe16e1e1a4174fd4bde533aa6eed722cdf43f7c8d28  apps/web/src/components/appointments/AppointmentForm.tsx
...
*Generated by sprint-completion-auditor at 2026-03-01T00:31:39.658Z*