...
**Run ID:** `sprint12-audit-20260301T215916-rs6fcu`
**Generated:** 01/03/2026, 21:59:56
...
| Validations | 8 passed | 11 failed |
| KPIs | 0 met | 0 missed |
...
### 🔴 Critical
- **IFC-042**: Validation(s) failed: pnpm --filter @intelliflow/api test --run
  - *Recommendation:* Fix failing validations before marking complete
- **IFC-081**: Validation(s) failed: pnpm test
  - *Recommendation:* Fix failing validations before marking complete
- **PG-009**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-010**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-011**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-012**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
- **PG-013**: Validation(s) failed: pnpm test
  - *Recommendation:* Fix failing validations before marking complete
- **PG-014**: Validation(s) failed: pnpm --filter @intelliflow/web test --run
  - *Recommendation:* Fix failing validations before marking complete
...
c39820badfcd6d7b3dcfebb53d3abea045e6dacfbe9d9f13a921534447f7be2f  apps/web/src/components/blog/markdown-renderer.tsx
...
377604206ee737882f892b08ce0027503ac39dc5033100d982110dd3a83ae41c  apps/web/src/lib/shared/ab-test-framework.ts
...
c0e87295968517b43e89e948b43a608fafbdda72a55585afede28c132defcd03  apps/web/lib/status/incident-tracker.ts
...
69e441d8b8a966b5b46cf2a2bba87e92f93988c7183cf9a860106b85bdacc87c  packages\platform\src\feature-flags\schema.ts
...
1a152ba6c8e6f4220c6f354015acab84d40012be27931aeddeec7291afac988c  apps/workers/notifications-worker/src/channels/sms.ts
...
*Generated by sprint-completion-auditor at 2026-03-01T21:59:56.041Z*