...
**Run ID:** `sprint11-audit-20260228T165122-062mji`
**Generated:** 28/02/2026, 17:25:25
**Duration:** 2043.7 seconds
**Strict Mode:** No
...
| KPIs | 0 met | 0 missed |
| Placeholders (in task artifacts) | - | 10 found |
...
- **IFC-158**: 9 DoD criteria unverified
  - *Recommendation:* Fix failing validations before marking complete
- **PG-141**: Found 3 placeholder(s) in task artifacts
  - *Recommendation:* Remove TODO, FIXME, STUB, and empty function placeholders
...
**Placeholders Found:**
- `apps\api\src\workflow\dsar-workflow.ts:599` - PLACEHOLDER: `// For now, return a placeholder URL...`
...
**Placeholders Found:**
- `apps\web\src\components\email\EmailList.tsx:124` - PLACEHOLDER: `...bg-transparent py-2 pl-9 pr-3 text-sm placehold...`
- `apps\web\src\components\email\EmailCompose.tsx:316` - PLACEHOLDER: `className="w-full bg-transparent text-sm placehold...`
...
0bdde48850010840111f2b6c9e4d617f0924a04e962c553a1cbfc9f75b5131ba  apps/api/src/workflow/dsar-workflow.ts
...
*Generated by sprint-completion-auditor at 2026-02-28T17:25:25.840Z*