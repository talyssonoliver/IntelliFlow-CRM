...
**Run ID:** `sprint10-audit-20260228T011105-q2x6cq`
**Generated:** 28/02/2026, 01:13:57
...
|----------|-------|--------|
| Artifacts | 146 ✓ | 11 missing, 0 empty |
| Validations | 0 passed | 2 failed |
| KPIs | 0 met | 0 missed |
| Placeholders (in task artifacts) | - | 85 found |
...
### 🔴 Critical
- **IFC-076**: Missing or invalid artifacts: SPEC:.specify/sprints/sprint-10/specifications/IFC-076-spec.md, PLAN:.specify/sprints/sprint-10/planning/IFC-076-plan.md, EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-076/context_pack.md, EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-076/context_ack.json
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-099**: Missing or invalid artifacts: EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-099/context_ack.json
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-099**: Validation(s) failed: pnpm test
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-113**: Missing or invalid artifacts: EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-113/context_ack.json
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-121**: Missing or invalid artifacts: EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-121/context_ack.json
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-141**: Missing or invalid artifacts: SPEC:.specify/sprints/sprint-10/specifications/IFC-141-spec.md, PLAN:.specify/sprints/sprint-10/planning/IFC-141-plan.md, EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-141/context_pack.md, EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-141/context_ack.json
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-141**: Validation(s) failed: pnpm test
  - *Recommendation:* Create all required artifacts before marking task complete

### 🟠 High
- **IFC-076**: Found 83 placeholder(s) in task artifacts
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-076**: 5 DoD criteria unverified
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-099**: Found 1 placeholder(s) in task artifacts
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-099**: 7 DoD criteria unverified
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-113**: Found 1 placeholder(s) in task artifacts
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-113**: 7 DoD criteria unverified
  - *Recommendation:* Create all required artifacts before marking task complete
- **IFC-121**: 6 DoD criteria unverified
  - *Recommendation:* Create all required artifacts before marking task complete
...
**Issues:**
- Missing or invalid artifacts: SPEC:.specify/sprints/sprint-10/specifications/IFC-076-spec.md, PLAN:.specify/sprints/sprint-10/planning/IFC-076-plan.md, EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-076/context_pack.md, EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-076/context_ack.json
- Found 83 placeholder(s) in task artifacts
...
- `SPEC:.specify/sprints/sprint-10/specifications/IFC-076-spec.md` (missing)
- `PLAN:.specify/sprints/sprint-10/planning/IFC-076-plan.md` (missing)
- `EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-076/context_pack.md` (missing)
- `EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-076/context_ack.json` (missing)

**Placeholders Found:**
- `packages\ui\__tests__\textarea.test.tsx:15` - PLACEHOLDER: `it('should render with placeholder', () => {...`
- `packages\ui\__tests__\textarea.test.tsx:16` - PLACEHOLDER: `render(<Textarea placeholder="Enter your message" ...`
- `packages\ui\__tests__\textarea.test.tsx:110` - PLACEHOLDER: `it('should have placeholder styles', () => {...`
- `packages\ui\__tests__\textarea.test.tsx:113` - PLACEHOLDER: `expect(textarea).toHaveClass('placeholder:text-mut...`
- `packages\ui\__tests__\select.test.tsx:23` - PLACEHOLDER: `<SelectValue placeholder="Select an option" />...`
- ... and 78 more
...
**Issues:**
- Missing or invalid artifacts: EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-099/context_ack.json
...
**Missing/Invalid Artifacts:**
- `EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-099/context_ack.json` (missing)

**Placeholders Found:**
- `packages\adapters\src\email\outlook\client.ts:513` - PLACEHOLDER: `// sendMail returns 202 with no body, so we return...`
...
**Description:** Implement secrets management and encryption at rest and in transit
**Status:** Completed

**Issues:**
- Missing or invalid artifacts: EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-113/context_ack.json
- Found 1 placeholder(s) in task artifacts
- 7 DoD criteria unverified
...
**Missing/Invalid Artifacts:**
- `EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-113/context_ack.json` (missing)

**Placeholders Found:**
- `apps\api\src\security\encryption.ts:155` - PLACEHOLDER: `// This is a placeholder that returns a derived ke...`

---

#### ❌ IFC-121

**Description:** Schedule periodic secret rotation and dependency vulnerability updates
**Status:** Completed

**Issues:**
- Missing or invalid artifacts: EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-121/context_ack.json
...
**Missing/Invalid Artifacts:**
- `EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-121/context_ack.json` (missing)
...
**Issues:**
- Missing or invalid artifacts: SPEC:.specify/sprints/sprint-10/specifications/IFC-141-spec.md, PLAN:.specify/sprints/sprint-10/planning/IFC-141-plan.md, EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-141/context_pack.md, EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-141/context_ack.json
- Validation(s) failed: pnpm test
...
**Missing/Invalid Artifacts:**
- `SPEC:.specify/sprints/sprint-10/specifications/IFC-141-spec.md` (missing)
- `PLAN:.specify/sprints/sprint-10/planning/IFC-141-plan.md` (missing)
- `EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-141/context_pack.md` (missing)
- `EVIDENCE:.specify/sprints/sprint-10/attestations/IFC-141/context_ack.json` (missing)
...
f4bd05119e9e29c0552d6430738f4977b5b0038d056390feb54399ed7958aa20  packages/adapters/src/email/outlook/client.ts
...
8e3207ab5d6c63c561e2a3188d770adf337d0643c21f76e34f046223cb0c47b9  packages/webhooks/package.json
...
16be7422db1acc0dd66ad3a31c7caa1e92e999ad03d2de62200c4c8953f29d1c  apps/api/src/security/encryption.ts
...
*Generated by sprint-completion-auditor at 2026-02-28T01:13:57.755Z*