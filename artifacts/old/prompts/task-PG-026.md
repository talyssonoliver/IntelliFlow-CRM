...
### Pre-requisites
FILE:artifacts/sprint0/codex-run/Framework.md;FILE:audit-matrix.yml;ENV:Payment form;ENV:Stripe Elements;FILE:apps/web/app/(billing)/billing/page.tsx

### Definition of Done
1. Response <200ms, Lighthouse ≥90, payments processing
2. artifacts: page.tsx, checkout-form.tsx, payment-processor.ts

### Artifacts to Track
- ARTIFACT:apps/web/app/(billing)/billing/checkout/page.tsx
- ARTIFACT:apps/web/components/billing/checkout-form.tsx
- ARTIFACT:apps/web/lib/billing/payment-processor.ts
- EVIDENCE:artifacts/attestations/PG-026/context_ack.json
