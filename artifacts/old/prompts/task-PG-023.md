...
### Pre-requisites
FILE:artifacts/sprint0/codex-run/Framework.md;FILE:audit-matrix.yml;ENV:Verification link;ENV:token validation;FILE:apps/web/app/(auth)/signup/page.tsx
...
### Artifacts to Track
- ARTIFACT:apps/web/app/(auth)/verify-email/[token]/page.tsx
- ARTIFACT:apps/web/components/shared/email-verification.tsx
- ARTIFACT:apps/web/lib/shared/account-activation.ts
- EVIDENCE:artifacts/attestations/PG-023/context_ack.json
