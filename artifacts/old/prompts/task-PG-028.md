...
- ENV: Invoice template
- ENV: line items shown
- [✗] FILE: `apps/web/app/(billing)/billing/invoices/page.tsx`

### Definition of Done
1. Response <200ms, Lighthouse ≥90, details displayed
2. artifacts: page.tsx, invoice-detail.tsx, invoice-actions.ts

### Artifacts to Track
- ARTIFACT:apps/web/app/(billing)/billing/invoices/[id]/page.tsx
- ARTIFACT:apps/web/components/billing/invoice-detail.tsx
- ARTIFACT:apps/web/lib/billing/invoice-actions.ts
- EVIDENCE:artifacts/attestations/PG-028/context_ack.json
