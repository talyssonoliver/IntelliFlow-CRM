...
**Sprint:** 14
**Section:** Tracking
**Owner:** PM + Security (STOA-Foundation)
**Status:** Backlog
...
**Dependency Status:**
- EXP-REPORTS-003 (DONE)
- IFC-118 (DONE)

### Pre-requisites
- [✓] FILE: `artifacts/reports/risk-register.csv`
- [✓] FILE: `docs/shared/risk-mitigation-plan.md`

### Definition of Done
1. Risk register displayed in table
2. add/edit risk modal
3. mitigation status tracking
4. export capability

### Artifacts to Track
- ARTIFACT:apps/project-tracker/components/tracking/RiskRegister.tsx
- ARTIFACT:apps/project-tracker/app/api/tracking/risks/route.ts
- EVIDENCE:artifacts/attestations/TRACK-003/context_ack.json
