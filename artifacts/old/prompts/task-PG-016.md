...
**Current Sprint:** 13
**Sprint Progress:** 7/16 (44%)

### Recommended Actions

1. Ready to start: PG-016, PG-018, PG-019

### Impact of Completing This Task

Completing **PG-016** will unblock: PG-017, PG-023

### Blocked Tasks (for context)

- **PG-017** ← blocked by: PG-016
- **PG-020** ← blocked by: PG-019
- **PG-022** ← blocked by: PG-021
- **PG-023** ← blocked by: PG-016
...
- ENV: Registration flow
- ENV: validation rules
- [✗] FILE: `apps/web/app/(auth)/login/page.tsx`

### Definition of Done
1. Response <200ms, Lighthouse ≥90, registration working
2. artifacts: page.tsx, registration-form.tsx, welcome-email.ts

### Artifacts to Track
- ARTIFACT:apps/web/app/(auth)/signup/page.tsx
- ARTIFACT:apps/web/components/shared/registration-form.tsx
- ARTIFACT:apps/web/lib/shared/welcome-email.ts
- EVIDENCE:artifacts/attestations/PG-016/context_ack.json
