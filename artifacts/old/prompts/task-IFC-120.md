...
### Definition of Done
1. Users can request password reset, receive secure token, reset password
2. email verification link sent on sign up
3. targets: <30s
4. verified by: pnpm test, pnpm test:e2e

### Artifacts to Track
- ARTIFACT:apps/web/app/(auth)/reset/page.tsx
- ARTIFACT:artifacts/misc/api/auth/reset.ts
- ARTIFACT:artifacts/misc/email-templates/reset.html
- ARTIFACT:apps/web/lib/shared/verification-mailer.ts
- EVIDENCE:artifacts/attestations/IFC-120/context_ack.json
