...
- ENV: Card management
- ENV: default selection
- [✗] FILE: `apps/web/app/(billing)/billing/page.tsx`

### Definition of Done
1. Response <200ms, Lighthouse ≥90, cards managed
2. artifacts: page.tsx, payment-methods.tsx, card-manager.ts

### Artifacts to Track
- ARTIFACT:apps/web/app/(billing)/billing/settings/page.tsx
- ARTIFACT:apps/web/components/billing/payment-methods.tsx
- ARTIFACT:apps/web/lib/billing/card-manager.ts
- EVIDENCE:artifacts/attestations/PG-029/context_ack.json
