...
**Current Sprint:** 14
**Sprint Progress:** 7/30 (23%)

### Recommended Actions

1. Ready to start: PG-025, TRACK-001, TRACK-002
...
- **TRACK-002**: Quality Metrics UI - Debt ledger coverage SonarQube with refresh buttons
- **TRACK-003**: Risk Register UI - View and update risks with mitigation tracking
- **TRACK-004**: AI Metrics UI - Model performance drift detection cost tracking

---

## TRACK-001 – Status Snapshot UI - Real-time task status tracking with manual refresh button

**Sprint:** 14
**Section:** Tracking
**Owner:** DevOps + Frontend Dev (STOA-Automation)
**Status:** Backlog
...
**Dependency Status:**
- EXP-REPORTS-001 (DONE)

### Pre-requisites
- [✓] FILE: `tools/audit/status_snapshot.py`
- [✓] FILE: `apps/project-tracker/lib/data-sync.ts`

### Definition of Done
1. UI displays status-snapshot.json
2. refresh button regenerates from CSV
3. history view shows changes over time

### Artifacts to Track
- ARTIFACT:apps/project-tracker/components/tracking/StatusTracker.tsx
- ARTIFACT:apps/project-tracker/app/api/tracking/status/route.ts
- EVIDENCE:artifacts/attestations/TRACK-001/context_ack.json
