...
### Pre-requisites
FILE:artifacts/sprint0/codex-run/Framework.md;FILE:audit-matrix.yml;ENV:Stripe integration;ENV:subscription management;FILE:artifacts/misc/connector-status-dashboard.json

### Definition of Done
1. Response <200ms, Lighthouse ≥90, billing functional
2. artifacts: page.tsx, billing-portal.tsx, stripe-portal.ts

### Artifacts to Track
- ARTIFACT:apps/web/app/(billing)/billing/page.tsx
- ARTIFACT:apps/web/components/billing/billing-portal.tsx
- ARTIFACT:apps/web/lib/billing/stripe-portal.ts
- EVIDENCE:artifacts/attestations/PG-025/context_ack.json
