...
This checklist ensures comprehensive observability coverage when adding
OpenTelemetry instrumentation to a new or existing service in IntelliFlow CRM.
...
- **SRE Review**: \***\*\*\*\*\***\_\_\_\***\*\*\*\*\*** Date: **\_\_\_**
- **Tech Lead**: \***\*\*\*\*\***\_\_\_\***\*\*\*\*\*** Date: **\_\_\_**

## Notes

Use this space for service-specific notes, custom instrumentation, or known
issues:
...
- Implementation Guide:
  `docs/architecture/observability/implementation-guide.md`
- Correlation Patterns:
  `docs/architecture/observability/correlation-patterns.md`
