...
> **Note**: `auth` has 22 rows in the table above (login through
> resendVerification) making it the single-router leader; `legal` is the largest
> functional group when its three sub-routers are summed.
