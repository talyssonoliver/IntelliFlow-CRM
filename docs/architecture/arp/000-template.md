...
**Reviewers:** [List of required reviewers - e.g., Architecture Team, Security
Team]
...
[1-2 paragraph summary of the proposed change. This should be understandable by
non-technical stakeholders and answer: What are we changing and why?]
...
[What happens if we don't make this change? Include business impact, technical
debt, risks]
...
[How will we migrate from current to proposed state? Blue-green deployment?
...
[Include detailed technical specifications, API contracts, database schemas,
etc.]
...
1. **Use ARPs for significant changes**: ARPs are for proposals that need review
   and consensus before implementation
2. **Start early**: Submit ARP before starting implementation to get feedback
3. **Be thorough**: Include enough detail for reviewers to make informed
   decisions
...
8. **Update status**: Keep status current as proposal moves through review
   process
