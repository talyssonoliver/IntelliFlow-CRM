...
> **⚠️ Partially superseded by [ADR-048](./ADR-048-hybrid-ai-inference.md).**
> The provider selection (OpenAI + Ollama) is replaced by the LiteLLM proxy +
> router. Other decisions in this ADR (Turborepo, tRPC, Prisma, Next.js,
> Supabase, observability) remain in force.
