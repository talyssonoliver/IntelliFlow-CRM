...
> **ℹ️ Context updated by [ADR-048](./ADR-048-hybrid-ai-inference.md).**
> Provider coupling is no longer a disqualifier because LiteLLM normalizes
> function-calling across OpenAI-compatible providers. The chosen tRPC-tools
