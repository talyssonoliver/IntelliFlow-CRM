...
[ADR-064](ADR-064-terraform-single-source-of-truth.md) (2026-06-05)
...
> SDK. The tool/architecture choices below stand; their *implementation status*
> did not. ADR-064 supersedes this ADR, extends scope to the workers + monitoring
> stack, and tracks the real remaining work via the `INFRA-TF-*` tasks.

See attestation files at
