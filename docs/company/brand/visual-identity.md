...
This document defines the visual identity for IntelliFlow CRM. All
implementations **MUST** reference the token files as the single source of
truth.
...
```html
<link
  href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL@24,400,0"
  rel="stylesheet"
/>
```
