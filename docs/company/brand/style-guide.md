...
Component patterns and implementation guidelines extracted from approved
mockups.

> **Location**: `docs/company/brand/style-guide.md` **Last Updated**: 2025-12-27
...
<!-- Qualification -->
<span
  class="px-2.5 py-1 rounded text-xs font-medium bg-primary/10 text-primary"
>
  Qualification
</span>
...
<!-- Proposal -->
<span
  class="px-2.5 py-1 rounded text-xs font-medium bg-indigo-100 text-indigo-700"
>
  Proposal
</span>
...
<!-- Negotiation -->
<span
  class="px-2.5 py-1 rounded text-xs font-medium bg-amber-100 text-amber-700"
>
  Negotiation
</span>
...
<!-- Closed Won -->
<span
  class="px-2.5 py-1 rounded text-xs font-medium bg-green-100 text-green-700"
>
  Closed Won
</span>
...
```html
<nav
  class="w-64 h-screen bg-white dark:bg-slate-900 border-r border-slate-200
...
<div class="border-b border-slate-200 dark:border-slate-800">
  <nav class="flex gap-6">
    <!-- Active Tab -->
    <button
      class="px-1 py-3 text-sm font-medium text-primary
    ...
    <!-- Inactive Tab -->
    <button
      class="px-1 py-3 text-sm font-medium text-slate-500
...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4">
  ...
  <!-- Modal -->
  <div
    class="relative bg-white dark:bg-slate-900 rounded-xl shadow-xl
...
<!-- Small (24px) -->
<div
  class="w-6 h-6 rounded-full bg-slate-200 dark:bg-slate-700
...
<!-- XL (48px) -->
<div
  class="w-12 h-12 rounded-full bg-slate-200 dark:bg-slate-700
...
<div class="flex-1 min-w-[280px] max-w-[320px]">
  ...
  <div class="space-y-2">
    <div
      class="bg-white dark:bg-slate-900 p-4 rounded-lg border
...
<div class="flex flex-col items-center justify-center py-12 px-4 text-center">
  <div
    class="w-16 h-16 rounded-full bg-slate-100 dark:bg-slate-800
...
```html
<div
  class="animate-spin w-5 h-5 border-2 border-slate-200 border-t-primary rounded-full"
></div>
```
...
This section maps each component to the user flows where it is used. Use this to
