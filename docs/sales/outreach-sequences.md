...
I noticed [Company] handles [practice area] cases - I'm curious how your team
currently tracks client intake and case deadlines?

Many firms like yours find their teams spending 40%+ of time on administrative
tasks rather than billable work.

We've helped firms like [Similar Firm] reduce admin overhead by 60% while
improving deadline compliance.

Would you be open to a 15-minute call to explore if IntelliFlow could help
[Company]?
...
I wanted to share a quick case study: [Similar Firm] increased their client
intake capacity by 3x without adding staff by automating their qualification
and scheduling workflow.

Is client intake and matter management something you're focused on improving
this quarter?
...
Thought you might find this interesting - we just published a brief guide on
how leading firms are using AI to:

1. Auto-score and qualify incoming client leads
2. Predict case outcomes and optimal pricing
3. Automate deadline tracking and court filing

[Link to resource]

Happy to discuss how any of these might apply to [Company].
...
I've reached out a few times and haven't heard back - totally understand if
the timing isn't right.

I'll close your file for now, but if case management or client intake ever
becomes a priority, I'm always happy to reconnect.

All the best to you and the team at [Company].
...
I noticed you're leading operations at [Company] - impressive work in the
[practice area] space.

Given your interest in AI for legal, thought you might find this case study
valuable: [Link]

Always happy to chat if you have questions about what we're seeing in the
market.
```
...
I've been thinking about our shared interest in modernizing legal operations,
and I'm curious: what's the biggest operational challenge [Company] is tackling
right now?

Would love to share some ideas over a quick 15-minute call if you're open to it.
```
...
- LinkedIn limits: Max 100 connection requests/week
- Phone: Respect do-not-call lists
- Document all opt-outs in CRM immediately
