...
**Purpose**: Introduce IntelliFlow CRM as a modern, AI-first CRM that combines automation with governance-grade validation for teams that need speed without sacrificing control.
...
**Visual Style**: Clean, modern design following brand attributes (modern, reliable, technical but approachable). Use semantic color tokens from `docs/company/brand/palette.tokens.json`.
...
2. **Problem**: Traditional CRMs force a false choice between speed and governance
3. **Solution**: IntelliFlow CRM delivers both through validation-first automation
...
**Reference**: `docs/company/go-to-market/objections.md` - Vendor lock-in response
...
**Reference**: `Sprint_plan.csv` - Decision gates (IFC-019, IFC-027, IFC-034, IFC-049)
...
- **Founder/GM**: Lead with Slide 2 (business impact), emphasize Slide 11 (roadmap)
- **Sales Lead**: Focus on Slides 6-7 (features + UX), show live demo
- **RevOps/Ops**: Deep dive on Slides 4-5 (governance + validation)
- **Engineering Lead**: Emphasize Slides 7-8 (tech stack + proof), show architecture docs
...
**Design Source**:
- Figma/Canva link TBD (to be added to `artifacts/misc/sales/pitch-deck-source-link.txt`)
