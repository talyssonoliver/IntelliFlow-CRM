...
**Version**: 1.0 **Effective Date**: 2025-12-30 **SLA**: 30 days from verified
request **Owner**: DPO + Legal Team

---

## Overview

This document outlines the process for handling Data Subject Access Requests
(DSAR) under GDPR Articles 15-22.
...
**Security Requirement**: Verify requestor is the data subject or authorized
representative.
...
**Storage**: Uploaded to secure S3 bucket with expiring pre-signed URL (valid
for 7 days).
...
**GDPR Allows**: 2-month extension if request complex or numerous requests from
same subject.
...
4. **Legal Obligation**: Data required by law to retain (inform subject of
   basis).
...
**Data Protection Officer**: Email: dpo@intelliflow-crm.com Address: [Company
Registered Office]
