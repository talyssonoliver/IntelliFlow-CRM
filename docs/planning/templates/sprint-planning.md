...
- Velocity achieved: **\_** story points
- Incomplete items:
  - [ ] Item 1 - Reason
  - [ ] Item 2 - Reason
- Carryover decision:
  - [ ] Continue in this sprint
  - [ ] Return to backlog
...
**Total Team Capacity:** **\_** story points

### 4. Backlog Selection (25 min)

| Priority | Item   | Points | Assignee | Notes |
| -------- | ------ | ------ | -------- | ----- |
| P1       | [Item] | [X]    | [Name]   |       |
| P2       | [Item] | [X]    | [Name]   |       |

**Total Committed:** **\_** story points

### 5. Task Breakdown (remaining time)
