...
**Owner:** Platform · **ADR:**
[ADR-064](../architecture/adr/ADR-064-terraform-single-source-of-truth.md) ·
**Date:** 2026-06-05

This is the execution plan for ADR-064 — making Terraform the single source of
truth for Vercel, Railway, Supabase, **and** the monitoring stack. It records
the audit findings, the phased plan, the new tasks, and the attestation
corrections.
...
1. Monitoring stack (Grafana/Prometheus/Loki/Tempo) **is brought under
   Terraform** (new `infra/terraform/modules/monitoring`).
