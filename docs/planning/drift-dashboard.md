...
**Location**: Grafana Dashboard ID: `ai-drift-monitoring` **URL**:
http://localhost:3000/d/ai-drift-monitoring

---

## Dashboard Overview

The AI Drift Dashboard provides real-time monitoring of all AI/ML models in
IntelliFlow CRM, tracking performance degradation, data drift, and business
impact.
