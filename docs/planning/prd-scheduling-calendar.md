...
## Summary
Provide conflict-aware scheduling, recurrence, buffers, and reliable bidirectional calendar sync (Google/Microsoft) with reconciliation.
...
- Calendar sync: idempotent upsert, etag/hash change detection, reconciliation job.
