...
**Decision Records:** ADR-020-public-site-auth.md

## Summary
Deliver marketing pages and auth flows with strong SEO/a11y/performance and secure signup/signin.
...
- Auth flows: signup/signin/logout with captcha/rate-limit; email verification if applicable.
