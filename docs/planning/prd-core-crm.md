...
**Related Tasks:** IFC-014, IFC-016, IFC-061, IFC-062, IFC-063, IFC-064, IFC-065, IFC-066, IFC-089, IFC-090, IFC-091, IFC-092, IFC-093, IFC-094, IFC-101–IFC-110, IFC-192, PG-131
**Decision Records:** ADR-019-core-crm-foundation.md

## Summary

Deliver a cohesive CRM workspace covering contacts, accounts, deals,
tasks/tickets, and document handling with consistent tenancy, state machines,
...
- CRUD for contacts/accounts/deals/tickets/docs with pagination, search,
  filters.
- Ticket and deal status enums with validated transitions; SLA timers emitted as
  events.
...
- Risk: Performance regressions under load → Mitigate with perf tests and
  indexes.
