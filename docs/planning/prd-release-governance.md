...
Define release promotion, supply-chain controls, SLOs, and incident processes to
ensure safe, auditable releases.

## Goals

- Promotion gate requiring tests/typecheck/lint/build + SBOM + signing +
  vulnerability scan.
...
- Promotion pass rate; time-to-restore; SLO compliance; number of unsigned
  artifacts (target 0).
