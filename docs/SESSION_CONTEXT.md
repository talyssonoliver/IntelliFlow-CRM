...
_Generated: 2026-04-26T21:28:31.182Z • Branch: master_
...
in progress, 0 open blocker(s) across the registry. Registry last updated 18m
...
- **Branch:** `master` (448 dirty file(s))
- **Dirty preview:**
...
- **Last 10 commits:**
  ...
  - `e20410d4` fix(docker): build webhooks/platform/adapters before web in
    Dockerfile.web — talyssonoliver, 11 hours ago
