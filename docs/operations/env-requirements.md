...
This document lists all required environment variables for IntelliFlow CRM
services.

> **Task**: IFC-169 - Require Supabase env vars **Last Updated**: 2026-01-28

## Overview

All services perform startup validation to ensure required environment variables
are set. Missing required variables will cause the service to fail fast with a
clear error message.
