...
**Document ID**: IFC-143-ABUSE-CASES **Version**: 1.0.0 **Last Updated**:
2025-12-31 **Owner**: Security Lead + AI Specialist (STOA-Security) **Status**:
Active
...
This document enumerates abuse cases for the IntelliFlow CRM system, focusing
on:
