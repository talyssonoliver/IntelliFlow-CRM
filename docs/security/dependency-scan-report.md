...
This document provides a template and current status of dependency vulnerability
scanning for IntelliFlow CRM.
...
Critical and high vulnerabilities trigger immediate Slack alerts to
`#security-alerts`.
...
_Report generated: 2025-12-29_ _Next scheduled scan: 2026-01-05 (weekly)_
