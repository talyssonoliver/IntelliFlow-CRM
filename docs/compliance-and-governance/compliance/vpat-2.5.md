...
**Report Date:** 2026-04-16 **Contact:** accessibility@intelliflow.com
**Evaluation Methods Used:** Static code review (92 routes), Lighthouse CI
...
**Level A Summary:** 25 Supports, 1 Partially Supports, 0 Does Not Support, 4
Not Applicable (30 criteria)
...
**Level AA Summary:** 16 Supports, 0 Partially Supports, 0 Does Not Support, 4
Not Applicable (20 criteria)
...
This VPAT is a self-assessment prepared by IntelliFlow CRM engineering. It is
not a certification of accessibility compliance. The conformance levels reported
reflect the state of the product at the evaluation date based on static code
review, automated testing (axe-core, Lighthouse CI), and manual inspection.
Actual user experience may vary depending on assistive technology, browser, and
operating system combinations.

This document should be reviewed and updated with each major release or at
...
| 1.5.0   | 2026-04-12 | Engineering (PG-056)          | Added `/500` system error page — scope now 90 routes                                                                                                                                                                                          |
| 1.6.0   | 2026-04-16 | Engineering (PG-186)          | Added `/documents/document-settings` module-settings page — scope now 91 routes                                                                                                                                                               |
| 1.7.0   | 2026-06-26 | Engineering (PG-181)          | Added `/settings/help-center/articles/new` help-article editor route (the `[id]/edit` dynamic route inherits) — scope now 92 routes; new editor uses labelled fieldset body group, `<output>` status regions, `aria-describedby` field errors |
