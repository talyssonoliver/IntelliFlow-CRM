...
- **LLM Providers:** LiteLLM proxy fronting Groq, Gemini (dev-only), Mistral
  (EU-DPA), Anthropic, OpenAI. See
  [ADR-048](../architecture/adr/ADR-048-hybrid-ai-inference.md).
- **Vector Database:** Supabase pgvector
- **Workflow Engine:** LangGraph

### Compliance Gate: Gemini Free Tier — EU-Tenant PII

| Gate                                      | Status  | Requirement                                                                                                                                                                               |
| ----------------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Gemini free tier excluded from EU tenants | Planned | Google's free Gemini tier trains on prompt data. Must be gated behind `NODE_ENV !== 'production'` for all EU-tenant workloads. Vertex AI migration required before any production EU use. |
| Mistral as EU-DPA LLM provider            | Planned | Route EU-tenant PII inference to Mistral (`standard` tier via LiteLLM) until Vertex AI is available. See [ADR-048](../architecture/adr/ADR-048-hybrid-ai-inference.md).                   |
...
- [ADR-006: Agent Tools](../architecture/adr/ADR-006-agent-tools.md)
...
- [ADR-005: Workflow Engine](../architecture/adr/ADR-005-workflow-engine.md)
- [ADR-006: Agent Tools](../architecture/adr/ADR-006-agent-tools.md)
...
docs/architecture/adr/ | | AI System Inventory | Partial | This document | | AI
Risk Assessments | Partial | Gap analysis | | AI Procedures | Planned |
docs/operations/ |
...
- [OpenTelemetry Config](../../infra/monitoring/otel-config.yaml)
...
- [ADR-009: Zero Trust](../architecture/adr/ADR-009-zero-trust-security.md)
