...
|--------------|--------|----------| | ADRs | Implemented |
docs/architecture/adr/ | | Security policies | Partial | docs/security/ | |
Procedures | Partial | docs/operations/ | | Records | Planned | artifacts/ |
...
- [OTEL Config](../../infra/monitoring/otel-config.yaml)
...
- [ADR-002: DDD](../architecture/adr/ADR-002-domain-driven-design.md)
- [ADR-009: Zero Trust](../architecture/adr/ADR-009-zero-trust-security.md)
...
- [GDPR Checklist](./gdpr-checklist.md)
- [Zero Trust ADR](../architecture/adr/ADR-009-zero-trust-security.md)
