...
**Reference:** `docs/compliance-and-governance/compliance/vpat-2.5.md`

- [ ] Spot-check WCAG Level A criteria (Table 1, 30 criteria) conformance levels
      in `docs/compliance-and-governance/compliance/vpat-2.5.md` lines 40-75.
      For each sampled criterion, confirm the stated conformance level matches
      current implementation.
- [ ] Spot-check WCAG Level AA criteria (Table 2, 20 criteria) conformance
      levels in `docs/compliance-and-governance/compliance/vpat-2.5.md` lines
      77-102. For each sampled criterion, confirm the stated conformance level
      matches current implementation.
- [ ] Review Section 508 Functional Performance Criteria rows 302.1-302.8
      (`docs/compliance-and-governance/compliance/vpat-2.5.md` lines 106+).
      Verify each row's conformance level and remarks are current.
- [ ] Verify Document Control table
      (`docs/compliance-and-governance/compliance/vpat-2.5.md` lines 129-135).
      Apply version increment rule: patch increment if no conformance level
      changes since last review; minor increment if any conformance level
      changed.
...
- [ ] Verify Section 3 metrics table denominators
      (`docs/compliance-and-governance/compliance/wcag-conformance-statement.md`
      lines 39-44) match current criteria counts.
...
**Reference:**
`docs/compliance-and-governance/compliance/wcag-conformance-statement.md`
Section 5 (lines 68-78),
`docs/compliance-and-governance/compliance/accessibility-gap-assessment.md`

- [ ] Review conformance statement Section 5 open limitations
      (`docs/compliance-and-governance/compliance/wcag-conformance-statement.md`
      lines 68-78). List each limitation and its current status.
...
- [ ] Cross-reference
      `docs/compliance-and-governance/compliance/accessibility-gap-assessment.md`
      failure registry. Verify no new failures have been introduced.
...
**Reference:**
`docs/compliance-and-governance/compliance/wcag-conformance-statement.md`
Section 8 (lines 122-170)

- [ ] Review conformance statement Section 8 schedule adherence
      (`docs/compliance-and-governance/compliance/wcag-conformance-statement.md`
      lines 122-170). Confirm AT testing was performed as scheduled.
...
`docs/compliance-and-governance/compliance/vpat-2.5.md` line 125 ("reviewed
every 6 months") with a more frequent 4-sprint cycle.
...
```
docs/compliance-and-governance/compliance/quarterly-a11y-reviews/sprint-{N}-review.md
```
...
- docs/compliance-and-governance/compliance/vpat-2.5.md (version increment)
- docs/compliance-and-governance/compliance/wcag-conformance-statement.md (route count update)
