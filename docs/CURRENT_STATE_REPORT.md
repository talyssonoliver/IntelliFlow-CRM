...
- Status: 3/43 completed, 40 backlog, 0 blocked.
- Primary focus areas: Core CRM (25), Settings (5), AI/ML (3).
- Evidence coverage: 3/3 completed tasks have canonical `attestation.json` evidence.
...
- **PG-132** — Smart Lead Routing UI - Rules configuration assignment dashboard SLA monitoring. PG-132 Smart Lead Routing UI — full implementation with 5 UI components, tRPC router (11 endpoints), validators, useRouting hook, and 64 passing tests. Key fix:... Routing rules CRUD with drag-to-reorder;...
- **IFC-078** — Platform Engineering Foundation. Task completed and verified Internal Developer Platform basics, golden paths
...
- **PG-059** — Leads List. response under 200ms, Lighthouse 90, pagination working
...
- Evidence coverage: 1/1 completed tasks have canonical `attestation.json` evidence.
