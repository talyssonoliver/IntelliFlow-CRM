...
- Queries: `getSession`, `getUser`, `getMfaStatus`, `listSessions`, `listMfaFactors`
- Mutations: `login`, `logout`, `register`, `forgotPassword`, `resetPassword`, `verifyEmail`, `setupMfa`, `verifyMfa`, `revokeMfa`, `revokeSession`
...
- Queries: `getDashboardMetrics`, `getRevenueByPeriod`, `getLeadsBySource`, `getConversionFunnel`, `getTeamPerformance`
...
- Queries: `list`, `getById`, `search`, `getByStatus`, `getScoreHistory`, `getActivities`, `getStatistics`, `exportCsv`
- Mutations: `create`, `update`, `delete`, `updateStatus`, `assignOwner`, `addNote`, `star`, `convertToContact`
...
- Queries: `list`, `getById`, `search`, `getByAccount`, `getActivities`, `getDeals`, `getTickets`
- Mutations: `create`, `update`, `delete`, `merge`, `addToAccount`, `removeFromAccount`, `addTag`
...
- Queries: `list`, `getById`, `search`, `getByCase`, `getByContact`, `getVersionHistory`, `getMetadata`
- Mutations: `create`, `update`, `delete`, `upload`, `addVersion`, `share`, `unshare`, `updateMetadata`, `sign`
...
- Mutations: `approveAction`, `rejectAction`, `requestHumanReview`, `submitFeedback`, `retryAction`, `cancelAction`

**Chain Version Router Procedures** (14 total):
- Queries: `list`, `getById`, `getActive`, `getExperiments`, `getMetrics`, `compareVersions`
- Mutations: `create`, `activate`, `deactivate`, `rollback`, `createExperiment`, `updateExperiment`, `endExperiment`, `setTrafficSplit`

**Intelligence Router Procedures** (6 total):
- Queries: `getLeadScore`, `getChurnRisk`, `getDealForecast`, `getSentimentAnalysis`
...
- Queries: `getSubscription`, `getInvoices`, `getPaymentMethods`, `getUsage`, `getPricingPlans`
- Mutations: `createCheckoutSession`, `updateSubscription`, `cancelSubscription`, `addPaymentMethod`, `removePaymentMethod`, `setDefaultPaymentMethod`

**Integration Note**: Stripe integration pending - currently using hardcoded data
...
Shows which implemented pages are connected to the backend vs using hardcoded/mock data.
