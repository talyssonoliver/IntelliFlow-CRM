...
/**
 * Cookie Consent Component Tests - EXP-ARTIFACTS-002
 *
 * Test coverage for:
...
describe('Accessibility', () => {
  ...
  it('should be keyboard navigable', async () => {
    ...
    // Tab through interactive elements - links come before buttons
    await user.tab(); // Privacy Policy link
    await user.tab(); // Cookie Policy link
    await user.tab(); // Reject All button
