...
// ============================================
export function NotesIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      {/* Shadow */}
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Notebook body */}
      <rect x="38" y="18" width="90" height="116" rx="6" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Spine holes */}
...
// ============================================
export function TasksIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      {/* Shadow */}
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Clipboard body */}
      <rect x="40" y="22" width="100" height="120" rx="8" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Clipboard top clip */}
      ...
      <polyline points="58,54 62,58 66,50" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <line x1="78" y1="54" x2="124" y2="54" stroke={S3} strokeWidth="2" strokeLinecap="round" />
      {/* Task row 2 — checked */}
      <rect x="54" y="72" width="16" height="16" rx="3" fill={P} />
      <polyline points="58,80 62,84 66,76" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <line x1="78" y1="80" x2="118" y2="80" stroke={S3} strokeWidth="2" strokeLinecap="round" />
      {/* Task row 3 — unchecked */}
      <rect x="54" y="98" width="16" height="16" rx="3" fill="none" stroke={PL} strokeWidth="1.5" strokeDasharray="3 2" />
      <line x1="78" y1="106" x2="112" y2="106" stroke={S2} strokeWidth="2" strokeLinecap="round" />
      {/* Decorative star */}
      <circle cx="146" cy="40" r="8" fill={PLT} />
      <text x="146" y="44" textAnchor="middle" fontSize="12" fill={P}>+</text>
    </svg>
  );
}
...
// ============================================
export function ChatsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      {/* Shadow */}
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      ...
      <polygon points="80,82 88,82 76,96" fill={PLT} stroke={PL} strokeWidth="1" strokeLinejoin="round" />
      ...
      <line x1="42" y1="74" x2="98" y2="74" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.7" />
      <line x1="42" y1="86" x2="88" y2="86" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.5" />
      <line x1="42" y1="98" x2="70" y2="98" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.3" />
...
// ============================================
export function AppointmentsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      {/* Shadow */}
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Calendar body */}
      <rect x="30" y="28" width="100" height="100" rx="8" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Calendar header */}
      ...
      {/* Day dots */}
      <text x="80" y="48" textAnchor="middle" fontSize="11" fontWeight="600" fill="white" fontFamily="Inter, sans-serif">MAR</text>
      {/* Grid dots */}
      {[0, 1, 2, 3, 4].map((col) =>
        [0, 1, 2, 3].map((row) => (
          <circle key={`${col}-${row}`} cx={46 + col * 18} cy={70 + row * 14} r="3" fill={row === 1 && col === 2 ? P : S2} />
        ))
      )}
      {/* Clock overlay */}
...
// ============================================
export function FilesIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      {/* Shadow */}
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      ...
      {/* File peeking out */}
      <rect x="56" y="24" width="68" height="90" rx="4" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* File corner fold */}
      ...
      <polyline points="124,50 130,42 136,50" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <line x1="130" y1="42" x2="130" y2="56" stroke="white" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
// ============================================
export function EmailsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      {/* Shadow */}
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Envelope body */}
      <rect x="24" y="44" width="132" height="88" rx="8" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Envelope flap */}
      <path d="M24 52 L90 94 L156 52" fill="none" stroke={S3} strokeWidth="1.5" strokeLinejoin="round" />
      {/* Inner flap shading */}
      <path d="M26 44 L90 86 L154 44" fill={PLT} />
      {/* Back flap */}
      <path d="M24 44 Q24 44 90 86 Q156 44 156 44" fill="none" stroke={PL} strokeWidth="1.5" strokeLinejoin="round" />
      {/* Bottom fold lines */}
...
// ============================================
export function TimelineIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      {/* Shadow */}
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      ...
      <circle cx="60" cy="112" r="8" fill="none" stroke={S3} strokeWidth="1.5" strokeDasharray="3 2" />
...
// ============================================
export function ActivityIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      {/* Shadow */}
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      ...
      {/* Card 2 */}
      <rect x="100" y="24" width="60" height="36" rx="6" fill="white" stroke={P} strokeWidth="1.5" />
      ...
      {/* Card 3 */}
      <rect x="56" y="100" width="68" height="36" rx="6" fill={S1} stroke={S2} strokeWidth="1" strokeDasharray="4 2" />
      <circle cx="72" cy="112" r="6" fill={S2} />
      <text x="72" y="116" textAnchor="middle" fontSize="10" fill={S4}>?</text>
...
// ============================================
export function DocumentsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      {/* Shadow */}
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      ...
      {/* Front document */}
      <rect x="38" y="22" width="84" height="114" rx="5" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Header line (title) */}
      ...
      <path d="M54 112 Q62 104 70 112 Q78 120 84 110" fill="none" stroke={P} strokeWidth="1.5" strokeLinecap="round" />
      {/* Stamp/seal */}
      ...
      <text x="136" y="113" textAnchor="middle" fontSize="11" fontWeight="700" fill={P} fontFamily="Inter, sans-serif">IF</text>
    </svg>
  );
}
...
// ============================================
export function LeadsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Person silhouette */}
      ...
      <polyline points="127,112 133,118 139,112" fill="none" stroke={P} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      {/* Star (quality lead) */}
      <circle cx="133" cy="130" r="10" fill={PLT} stroke={PL} strokeWidth="1" />
      <text x="133" y="134" textAnchor="middle" fontSize="12" fill={P}>&#9733;</text>
    </svg>
  );
}
...
// ============================================
export function ContactsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Address book body */}
      <rect x="36" y="16" width="108" height="124" rx="8" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Spine */}
      ...
      {/* Empty slot (dashed) */}
      <circle cx="76" cy="120" r="10" fill="none" stroke={S3} strokeWidth="1" strokeDasharray="3 2" />
      <line x1="92" y1="116" x2="122" y2="116" stroke={S2} strokeWidth="2" strokeLinecap="round" strokeDasharray="4 3" />
      <line x1="92" y1="126" x2="108" y2="126" stroke={S2} strokeWidth="2" strokeLinecap="round" strokeDasharray="4 3" />
    </svg>
  );
}
...
// ============================================
export function AccountsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Main building */}
      <rect x="50" y="30" width="60" height="112" rx="4" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Building top */}
      ...
      {[0, 1, 2].map((col) =>
        [0, 1, 2, 3].map((row) => (
          <rect key={`${col}-${row}`} x={60 + col * 16} y={56 + row * 20} width="10" height="10" rx="1.5" fill={row < 2 ? PLT : S1} stroke={row < 2 ? PL : S2} strokeWidth="0.5" />
        ))
      )}
      {/* Door */}
...
// ============================================
export function DealsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Pipeline stages */}
      ...
      <rect x="146" y="20" width="20" height="96" rx="4" fill={S2} strokeDasharray="4 2" stroke={S3} strokeWidth="1" />
      {/* Stage labels */}
      <text x="32" y="92" textAnchor="middle" fontSize="8" fill="white" fontFamily="Inter, sans-serif">Q</text>
      <text x="64" y="86" textAnchor="middle" fontSize="8" fill="white" fontFamily="Inter, sans-serif">P</text>
      <text x="96" y="82" textAnchor="middle" fontSize="8" fill="white" fontFamily="Inter, sans-serif">N</text>
      <text x="128" y="78" textAnchor="middle" fontSize="8" fill={P} fontFamily="Inter, sans-serif">W</text>
      {/* Dollar value */}
      <rect x="46" y="124" width="88" height="22" rx="6" fill="white" stroke={P} strokeWidth="1.5" />
      <text x="90" y="140" textAnchor="middle" fontSize="13" fontWeight="600" fill={P} fontFamily="Inter, sans-serif">$0.00</text>
      {/* Trend arrow */}
      <polyline points="130,50 140,36 150,44" fill="none" stroke={S3} strokeWidth="1.5" strokeLinecap="round" strokeDasharray="3 2" />
    </svg>
  );
}
...
// ============================================
export function TicketsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Ticket body */}
      <rect x="28" y="30" width="124" height="80" rx="8" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Ticket perforation */}
      ...
      <text x="54" y="100" textAnchor="middle" fontSize="7" fill={P} fontFamily="Inter, sans-serif">Open</text>
      {/* Right section — stub */}
      <rect x="128" y="46" width="16" height="16" rx="4" fill={PLT} />
      <text x="136" y="58" textAnchor="middle" fontSize="14" fill={P} fontFamily="Inter, sans-serif">#</text>
      ...
      <polygon points="70,142 78,142 66,152" fill={PLT} stroke={PL} strokeWidth="1" strokeLinejoin="round" />
...
// ============================================
export function CasesIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Briefcase body */}
      <rect x="34" y="50" width="112" height="76" rx="8" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Briefcase handle */}
      <path d="M68 50 L68 38 Q68 30 76 30 L104 30 Q112 30 112 38 L112 50" fill="none" stroke={S3} strokeWidth="2" />
      {/* Lock clasp */}
...
// ============================================
export function PinnedIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Board */}
      ...
      {/* Empty slot (dashed) */}
      <rect x="54" y="86" width="72" height="36" rx="4" fill="none" stroke={S3} strokeWidth="1.5" strokeDasharray="6 3" />
      <text x="90" y="108" textAnchor="middle" fontSize="20" fill={S3}>+</text>
    </svg>
  );
}
...
// ============================================
export function InsightsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Lightbulb glass */}
      <path d="M90 20 C60 20 42 44 42 68 C42 86 54 96 62 106 L62 112 L118 112 L118 106 C126 96 138 86 138 68 C138 44 120 20 90 20Z" fill={PLT} stroke={PL} strokeWidth="1.5" />
      {/* Filament */}
      <path d="M78 80 Q84 66 90 80 Q96 94 102 80" fill="none" stroke={P} strokeWidth="2" strokeLinecap="round" />
      {/* Bulb base */}
...
// ============================================
export function NotificationsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Bell body */}
      <path d="M56 88 C56 56 68 28 90 28 C112 28 124 56 124 88 L124 98 L56 98 Z" fill={PLT} stroke={PL} strokeWidth="1.5" />
      {/* Bell rim */}
      ...
      {/* Sound waves */}
      <path d="M40 72 Q34 82 40 92" fill="none" stroke={PL} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M30 66 Q22 82 30 98" fill="none" stroke={PL} strokeWidth="1" strokeLinecap="round" opacity="0.5" />
      <path d="M140 72 Q146 82 140 92" fill="none" stroke={PL} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M150 66 Q158 82 150 98" fill="none" stroke={PL} strokeWidth="1" strokeLinecap="round" opacity="0.5" />
      {/* Checkmark badge */}
      <circle cx="140" cy="40" r="14" fill="white" stroke={P} strokeWidth="1.5" />
      <polyline points="133,40 138,45 148,35" fill="none" stroke={P} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
// ============================================
export function CommentsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Comment bubble */}
      <rect x="28" y="24" width="108" height="76" rx="12" fill="white" stroke={S3} strokeWidth="1.5" />
      <polygon points="56,100 64,100 48,118" fill="white" stroke={S3} strokeWidth="1.5" strokeLinejoin="round" />
      {/* Lines */}
...
// ============================================
export function InvoicesIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Receipt body */}
      <rect x="42" y="14" width="96" height="124" rx="4" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Zigzag bottom */}
      <path d="M42 138 L50 130 L58 138 L66 130 L74 138 L82 130 L90 138 L98 130 L106 138 L114 130 L122 138 L130 130 L138 138" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Header */}
      <rect x="56" y="26" width="68" height="8" rx="2" fill={P} />
      {/* Amount */}
      <text x="90" y="58" textAnchor="middle" fontSize="16" fontWeight="700" fill={P} fontFamily="Inter, sans-serif">$0.00</text>
      {/* Divider */}
...
// ============================================
export function ReceiptsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Receipt body */}
      <rect x="46" y="18" width="88" height="116" rx="4" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Zigzag bottom */}
      <path d="M46 134 L54 126 L62 134 L70 126 L78 134 L86 126 L94 134 L102 126 L110 134 L118 126 L126 134 L134 126" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Header stripe */}
      ...
      <line x1="104" y1="102" x2="122" y2="102" stroke={P} strokeWidth="2.5" strokeLinecap="round" />
      {/* Checkmark badge */}
      <circle cx="138" cy="36" r="16" fill={P} />
      <polyline points="130,36 136,42 148,30" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
// ============================================
export function PaymentMethodsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Back card (tilted) */}
      <rect x="48" y="24" width="110" height="70" rx="8" fill={S1} stroke={S2} strokeWidth="1" transform="rotate(6, 103, 59)" />
      {/* Front card */}
      <rect x="24" y="38" width="120" height="76" rx="8" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Card stripe */}
...
// ============================================
export function SignaturesIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Document */}
      <rect x="36" y="16" width="88" height="120" rx="5" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Lines */}
      ...
      <text x="52" y="106" fontSize="8" fill={S4} fontFamily="Inter, sans-serif">Sign here</text>
      {/* Signature stroke */}
      <path d="M54 104 Q66 90 78 104 Q90 118 100 100" fill="none" stroke={P} strokeWidth="2" strokeLinecap="round" />
      {/* Pen */}
...
// ============================================
export function AgentsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Body */}
      <rect x="50" y="62" width="80" height="72" rx="10" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Head */}
      ...
      {/* Mouth */}
      <path d="M80 56 Q90 62 100 56" fill="none" stroke={PL} strokeWidth="1.5" strokeLinecap="round" />
      {/* Arms */}
...
// ============================================
export function RulesIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Start node */}
      ...
      <text x="90" y="76" textAnchor="middle" fontSize="10" fill={P} fontFamily="Inter, sans-serif">?</text>
      {/* Left branch */}
      ...
      <rect x="126" y="112" width="36" height="22" rx="4" fill="white" stroke={P} strokeWidth="1.5" />
...
// ============================================
export function ReportsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Chart background */}
      <rect x="28" y="18" width="124" height="118" rx="8" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Grid lines */}
      ...
      {/* Trend line */}
      <polyline points="65,80 85,58 105,44 125,68" fill="none" stroke={P} strokeWidth="2" strokeLinecap="round" strokeDasharray="4 3" />
    </svg>
  );
}
...
// ============================================
export function SearchIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Magnifying glass */}
...
// ============================================
export function ExperimentsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Flask neck */}
      <rect x="78" y="18" width="24" height="40" rx="2" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Flask body */}
      <path d="M78 58 L48 118 Q44 128 54 132 L126 132 Q136 128 132 118 L102 58 Z" fill={PLT} stroke={PL} strokeWidth="1.5" />
      {/* Liquid */}
      <path d="M60 108 L90 108 L120 108 Q128 118 122 126 L58 126 Q52 118 60 108 Z" fill={P} opacity="0.3" />
      {/* Bubbles */}
      ...
      {/* A/B labels */}
      <text x="72" y="90" fontSize="12" fontWeight="700" fill={P} fontFamily="Inter, sans-serif">A</text>
      <text x="100" y="90" fontSize="12" fontWeight="700" fill={PL} fontFamily="Inter, sans-serif">B</text>
      {/* Stopper */}
...
// ============================================
export function ProductsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Box body */}
      <rect x="34" y="54" width="112" height="84" rx="6" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Box lid */}
      ...
      <text x="148" y="56" textAnchor="middle" fontSize="10" fontWeight="600" fill={P} fontFamily="Inter, sans-serif">$</text>
...
// ============================================
export function SubscriptionsIllustration({ className, width = defaultSize.width, height = defaultSize.height }: Readonly<IllustrationProps>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 180 160" fill="none" className={className} aria-hidden="true">
      <ellipse cx="90" cy="148" rx="60" ry="6" fill={S2} />
      {/* Plan card */}
      <rect x="34" y="20" width="112" height="118" rx="10" fill="white" stroke={S3} strokeWidth="1.5" />
      {/* Header */}
      <rect x="34" y="20" width="112" height="32" rx="10" fill={P} />
      <rect x="34" y="38" width="112" height="14" fill={P} />
      <text x="90" y="42" textAnchor="middle" fontSize="13" fontWeight="600" fill="white" fontFamily="Inter, sans-serif">PRO PLAN</text>
      {/* Price */}
      <text x="90" y="78" textAnchor="middle" fontSize="22" fontWeight="700" fill={P} fontFamily="Inter, sans-serif">$0</text>
      <text x="90" y="92" textAnchor="middle" fontSize="10" fill={S4} fontFamily="Inter, sans-serif">/month</text>
      {/* Feature checks */}
      <g>
        <circle cx="56" cy="108" r="5" fill={PLT} />
        <polyline points="53,108 55,110 59,106" fill="none" stroke={P} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <line x1="66" y1="108" x2="100" y2="108" stroke={S2} strokeWidth="2" strokeLinecap="round" />
      </g>
      <g>
        <circle cx="56" cy="122" r="5" fill={PLT} />
        <polyline points="53,122 55,124 59,120" fill="none" stroke={P} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <polyline points="118,120 124,126 132,114" fill="none" stroke={P} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
