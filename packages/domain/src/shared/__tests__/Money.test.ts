...
describe('Money', () => {
  describe('create()', () => {
    ...
    it('should uppercase currency code', () => {
      const result = Money.create(10, 'usd');
    ...
    it('should round to nearest cent', () => {
      const result = Money.create(12.345, 'USD');
  ...
  describe('fromCents()', () => {
    it('should create money from valid cents', () => {
      const result = Money.fromCents(1250, 'USD');
    ...
    it('should fail for non-integer cents', () => {
      const result = Money.fromCents(12.5, 'USD');
  ...
  describe('formatted property', () => {
    it('should return a currency-formatted string for USD', () => {
      const money = Money.create(1234.56, 'USD').value;

      expect(money.formatted).toContain('1,234.56');
    });

    it('should include currency symbol', () => {
      const money = Money.create(10, 'USD').value;
  ...
  describe('add()', () => {
    it('should add two money values of the same currency', () => {
      const m1 = Money.create(10, 'USD').value;
      const m2 = Money.create(5, 'USD').value;
  ...
  describe('subtract()', () => {
    it('should subtract two money values of the same currency', () => {
      const m1 = Money.create(10, 'USD').value;
      const m2 = Money.create(3, 'USD').value;
    ...
    it('should fail when result would be negative', () => {
      const m1 = Money.create(5, 'USD').value;
      const m2 = Money.create(10, 'USD').value;
      const result = m1.subtract(m2);
  ...
  describe('greaterThan()', () => {
    it('should return true when this amount is greater', () => {
      const m1 = Money.create(20, 'USD').value;
      const m2 = Money.create(10, 'USD').value;
    ...
    it('should return false when this amount is less', () => {
      const m1 = Money.create(10, 'USD').value;
      const m2 = Money.create(20, 'USD').value;
