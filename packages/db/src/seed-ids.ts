...
export const SEED_IDS = {
  ...
  leads: {
    ...
    // Queue leads for routing UI (PG-132)
    kevinTaylor: seedUUID('02', 7),
    rachelGreen: seedUUID('02', 8),
    tomBrown: seedUUID('02', 9),
    lisaPark: seedUUID('02', 10),
    carlosRivera: seedUUID('02', 11),
  ...
  agentSkills: {
    ...
    emilyBilling: seedUUID('3d', 4),
    emilySMBSales: seedUUID('3d', 5),
    jamesAPI: seedUUID('3d', 6),
    jamesDemos: seedUUID('3d', 7),
    alexSalesConsulting: seedUUID('3d', 8),
    davidEnterprise: seedUUID('3d', 9),
    janeCustomerSuccess: seedUUID('3d', 10),
    sarahJLeadQual: seedUUID('3d', 11),
  },
  agentAvailability: {
    ...
    jamesAvailable: seedUUID('3e', 4),
    alexAvailable: seedUUID('3e', 5),
    davidAvailable: seedUUID('3e', 6),
    janeAvailable: seedUUID('3e', 7),
    sarahJAvailable: seedUUID('3e', 8),
  },
  routingRules: {
    ...
    // New lead-focused rules for routing UI (PG-132)
    highValueLeads: seedUUID('3f', 4),
    technicalEvaluation: seedUUID('3f', 5),
    websiteInquiries: seedUUID('3f', 6),
    referralLeads: seedUUID('3f', 7),
    lowScoreNurture: seedUUID('3f', 8),
  },
  // Routing audit records for routing UI (PG-132)
  routingAudits: {
    audit1: seedUUID('60', 1),
    audit2: seedUUID('60', 2),
    audit3: seedUUID('60', 3),
    audit4: seedUUID('60', 4),
    audit5: seedUUID('60', 5),
    audit6: seedUUID('60', 6),
    audit7: seedUUID('60', 7),
    audit8: seedUUID('60', 8),
    audit9: seedUUID('60', 9),
    audit10: seedUUID('60', 10),
    audit11: seedUUID('60', 11),
    audit12: seedUUID('60', 12),
    audit13: seedUUID('60', 13),
    audit14: seedUUID('60', 14),
    audit15: seedUUID('60', 15),
  },
  ticketCategories: {
  ...
  leadActivities: {
    ...
    sarahMillerWebForm: seedUUID('53', 9),
    sarahMillerCall: seedUUID('53', 10),
    davidChenEmail: seedUUID('53', 11),
    davidChenMeeting: seedUUID('53', 12),
    amandaSmithCall: seedUUID('53', 13),
    amandaSmithNote: seedUUID('53', 14),
    jamesWilsonEmail: seedUUID('53', 15),
    jamesWilsonScoreUpdate: seedUUID('53', 16),
    elenaRodriguezWebForm: seedUUID('53', 17),
    elenaRodriguezCall: seedUUID('53', 18),
    kevinTaylorEmail: seedUUID('53', 19),
    kevinTaylorStatusChange: seedUUID('53', 20),
    rachelGreenMeeting: seedUUID('53', 21),
    rachelGreenNote: seedUUID('53', 22),
    tomBrownCall: seedUUID('53', 23),
    tomBrownEmail: seedUUID('53', 24),
    lisaParkWebForm: seedUUID('53', 25),
    lisaParkScoreUpdate: seedUUID('53', 26),
    carlosRiveraCall: seedUUID('53', 27),
    carlosRiveraMeeting: seedUUID('53', 28),
    ninaPatelEmail: seedUUID('53', 29),
    ninaPatelCall: seedUUID('53', 30),
    ninaPatelWebForm: seedUUID('53', 31),
    ryanMurphyNote: seedUUID('53', 32),
    ryanMurphyEmail: seedUUID('53', 33),
    dianaHallCall: seedUUID('53', 34),
    dianaHallMeeting: seedUUID('53', 35),
  },
  leadNotes: {
    ...
    sarahMillerNote: seedUUID('54', 3),
    davidChenNote: seedUUID('54', 4),
    ninaPatelNote: seedUUID('54', 5),
    elenaRodriguezNote: seedUUID('54', 6),
    rachelGreenNote: seedUUID('54', 7),
  },
  leadFiles: {
    ...
    sarahMillerProposal: seedUUID('55', 3),
    davidChenSpec: seedUUID('55', 4),
    ninaPatelRfp: seedUUID('55', 5),
    elenaRodriguezContract: seedUUID('55', 6),
  },
  leadAIInsights: {
    marcusReed: seedUUID('56', 1), // 00000000-0000-4000-8000-000000005601
    sarahMiller: seedUUID('56', 2),
    davidChen: seedUUID('56', 3),
    amandaSmith: seedUUID('56', 4),
    jamesWilson: seedUUID('56', 5),
    elenaRodriguez: seedUUID('56', 6),
    kevinTaylor: seedUUID('56', 7),
    rachelGreen: seedUUID('56', 8),
    tomBrown: seedUUID('56', 9),
    lisaPark: seedUUID('56', 10),
    carlosRivera: seedUUID('56', 11),
    ninaPatel: seedUUID('56', 12),
    ryanMurphy: seedUUID('56', 13),
    dianaHall: seedUUID('56', 14),
  },
