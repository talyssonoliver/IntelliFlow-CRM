        ...
        <div className="container px-4 lg:px-6 mx-auto max-w-6xl space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {LOADING_FEATURES_B.map((k) => (
              <div key={k} className="p-6 bg-slate-50 rounded-xl border border-slate-200 space-y-4">
                <div className="h-12 w-12 bg-slate-200 rounded-lg" />
        ...
        <div className="container px-4 lg:px-6 mx-auto max-w-6xl space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {LOADING_FEATURES_C.map((k) => (
              <div key={k} className="p-6 bg-white/10 rounded-xl border border-white/10 space-y-4">
