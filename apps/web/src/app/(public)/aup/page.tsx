...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Acceptable Use Policy | IntelliFlow CRM',
    description:
      'IntelliFlow CRM AUP — prohibited activities, content rules, security expectations, and reporting.',
  },
  alternates: {
    canonical: '/aup',
  },
        ...
        <div className="container px-4 lg:px-6 mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-slate-600 dark:text-slate-400">
              IntelliFlow CRM is a shared platform. This Acceptable Use Policy explains the
              activities, content, and behaviours that keep it safe and dependable for everyone, and
              the channels available to report a suspected violation.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              <Card className="border-slate-200 bg-[#137fec]/5 p-6 shadow-sm dark:border-slate-800 dark:bg-[#137fec]/10">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  ...
                  and{' '}
                  <Link href="/terms" className="font-medium text-[#137fec] hover:underline">
                    Terms of Service
                  </Link>{' '}
