 ...
 * The parent Server Component may pass `initialData` in the future
 * to hydrate React Query instantly.
 */
...
export default function LeadsPageClient({ initialData: serverData }: LeadsPageClientProps = {}) {
  ...
  // tRPC mutations with query invalidation + server cache revalidation
