      ...
      const contactData = {
        ...
        contactType:
          formData.contactType === 'other'
            ? ('other' as const)
            : (toOptional(formData.contactType) as
                | 'customer'
                | 'prospect'
                | 'partner'
                | 'vendor'
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {formData.department === 'other' && (
                      <div className="space-y-1.5">
                        ...
                        />
                        {errors.departmentOther && (
                          <p className="text-xs text-red-500">{errors.departmentOther}</p>
                        )}
                      </div>
                    )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {formData.contactType === 'other' && (
                      <div className="space-y-1.5 md:col-span-2">
                        ...
                        />
                        {errors.contactTypeOther && (
                          <p className="text-xs text-red-500">{errors.contactTypeOther}</p>
                        )}
                      </div>
                    )}
        ...
        <div className="flex items-start gap-3 p-4 rounded-lg bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-800/30">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-300/80">
              You can skip the &apos;Additional Info&apos; step if you don&apos;t have all details
              handy. You can always enrich the contact profile later from the contact detail view or
              through data enrichment integrations.
            </p>
          </div>
        </div>
      </div>
