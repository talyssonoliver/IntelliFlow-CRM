...
export default function DealSettingsPage() {
  return (
    <div className="flex flex-1 flex-col p-6">
      <h1 className="text-2xl font-semibold tracking-tight">Deal Settings</h1>
      <p className="text-muted-foreground mt-1">Configure deal fields, statuses, and defaults.</p>
