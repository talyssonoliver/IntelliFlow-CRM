...
const COMPLIANCE_STANDARDS: Record<string, Omit<ComplianceDetailResponse, 'standardId'>> = {
  'iso-27001': {
    ...
    controls: [
      ...
      {
        id: 'A.8.1',
        name: 'Asset management - Responsibility',
        status: 'passed',
        lastAssessed: '2025-12-15',
      },
      {
      ...
      },
      {
        ...
        lastAssessed: '2025-12-15',
        notes: 'Cloud-only infrastructure',
      },
      {
        id: 'A.12.1',
  ...
  'iso-42001': {
    ...
    controls: [
      ...
      },
      {
        ...
        status: 'failed',
        lastAssessed: '2025-12-01',
        notes: 'Policy not yet formalized',
      },
    ...
    recentChanges: [
      ...
      {
        date: '2025-11-15',
        action: 'Initial gap assessment completed',
  ...
  owasp: {
    ...
    controls: [
      ...
      },
      {
        ...
        status: 'in_progress',
        lastAssessed: '2025-11-01',
        notes: 'Ongoing dependency updates',
      },
