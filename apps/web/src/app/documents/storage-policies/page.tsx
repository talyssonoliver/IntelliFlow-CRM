    ...
    <div className="flex flex-1 flex-col p-6">
      ...
      <div className="mt-8 flex flex-1 items-center justify-center">
        <div className="text-center">
          <span className="material-symbols-outlined text-5xl text-muted-foreground/40">cloud_sync</span>
          <p className="mt-4 text-sm text-muted-foreground">Storage policies configuration coming soon.</p>
        </div>
      </div>
    </div>
  );
