...
describe('ui-flow-mapping.md Reconciliation', () => {
  ...
  it('Total Pages count matches filesystem page.tsx count', () => {
    ...
    expect(
      match,
      'Could not find **Total Pages**: N in ui-flow-mapping.md header'
    ).toBeTruthy();
  ...
  it('API Router count matches router.ts registrations', () => {
    ...
    expect(
      match,
      'Could not find **API Routers**: N in ui-flow-mapping.md header'
    ).toBeTruthy();
  ...
  it('procedure count in header matches API Router Summary table total', () => {
    ...
    expect(
      headerMatch,
      'Could not find (N procedures) in ui-flow-mapping.md header'
    ).toBeTruthy();
