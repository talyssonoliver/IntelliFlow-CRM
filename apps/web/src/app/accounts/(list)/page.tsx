...
import AccountsPageClient, { type AccountStats } from './AccountsPageClient';
...
export default async function AccountsPage() {
  ...
  let initialStats: AccountStats | undefined;
  try {
    ...
    initialStats = serializeForClient(raw) as AccountStats;
  } catch {
