...
export interface CustomFieldsTabHandle {
  openCreate: () => void;
}
import {
  Button,
...
export const CustomFieldsTab = forwardRef<CustomFieldsTabHandle, CustomFieldsTabProps>(
  function CustomFieldsTab({ rows, onCreate, onUpdate, onDelete, isBusy = false }, ref) {
      ...
      <div className="space-y-4">
        {rows.length === 0 ? (
          <EmptyState
            ...
            description="Capture extra account data with a custom field."
