/** Job listings data module — single source of truth for job data used by sitemap.ts and careers/[id]/page.tsx */
...
export const jobListings: Record<string, JobListing> = {
  'sr-fullstack-eng': {
    id: 'sr-fullstack-eng',
