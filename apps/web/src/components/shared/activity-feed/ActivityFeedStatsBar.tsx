...
import { useActivityFeedStats, type UseActivityFeedStatsOptions } from '@/hooks/useActivityFeedStats';
...
const TYPE_CONFIG: Record<string, { label: string; color: string }> = {
  STATUS_CHANGE: { label: 'Status', color: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' },
  NOTE: { label: 'Notes', color: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400' },
  EMAIL: { label: 'Emails', color: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400' },
  CALL: { label: 'Calls', color: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' },
  MEETING: { label: 'Meetings', color: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400' },
  TASK: { label: 'Tasks', color: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400' },
  DEAL: { label: 'Deals', color: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' },
  SYSTEM: { label: 'System', color: 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400' },
  CHAT: { label: 'Chat', color: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400' },
  ASSIGNMENT: { label: 'Assigned', color: 'bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400' },
  CREATION: { label: 'Created', color: 'bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400' },
};
