        ...
        <Card className="border border-slate-200 dark:border-slate-800">
          <CardContent className="p-8 flex items-start gap-5">
            <div className="w-12 h-12 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center shrink-0">
              <span
                className="material-symbols-outlined text-2xl text-slate-400 dark:text-slate-500"
                aria-hidden="true"
              >
                credit_card_off
              </span>
            ...
            <div className="flex flex-col gap-3">
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  You don&apos;t have an active subscription to cancel. Browse our plans to get
                  started, or return to the billing overview.
                </p>
              </div>
      ...
      <div className="px-8 pt-8 pb-6 border-b border-slate-200 dark:border-slate-700">
        <div className="relative flex items-center justify-between w-full max-w-2xl mx-auto">
          ...
          {STEPS.map((step) => {
            ...
            if (status === 'current') {
              circleClass = 'bg-[#137fec] text-white';
            } else if (status === 'completed') {
              circleClass = 'bg-[#137fec] text-white hover:bg-[#0e6ac7]';
            } else {
              circleClass =
            ...
            return (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm ring-4 ring-white dark:ring-slate-900 shadow-sm transition-all ${circleClass}`}
                >
                  {status === 'completed' ? (
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-400 mt-1">
                      Stay and get {cancellationInfo.retentionOffer.discountPercent}% off your next 3
                      months.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4 p-5 rounded-xl border border-red-200 dark:border-red-800 bg-red-50/50 dark:bg-red-900/10">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm text-red-700 dark:text-red-400" aria-live="polite">
                    ...
                    {formatBillingDate(subscription.currentPeriodEnd)}. After that, you&apos;ll lose
