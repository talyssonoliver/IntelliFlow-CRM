...
/**
 * Renders the settings items inline in the sidebar when on a calendar settings page.
 * Calendar Views & By Type sections are rendered natively by the sidebar via `sections`.
 */
export function CalendarSettingsSidebarNav({
  isExpanded: sidebarExpanded,
}: Readonly<CalendarSettingsSidebarNavProps>) {
  ...
  return (
    <div className="flex flex-col gap-1">
      <div>
        ...
        >
          <div className="w-7 h-7 rounded-md flex items-center justify-center flex-shrink-0 bg-purple-50 dark:bg-purple-950">
            <span
          ...
          {sidebarExpanded && <span className="font-medium truncate">Calendar Settings</span>}
        </div>
      ...
      {/* ── Divider between settings and Calendar Views ── */}
