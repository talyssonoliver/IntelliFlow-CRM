...
const DOC_TYPE_ICONS: Record<string, string> = {
  ...
  COURT_FILING: 'gavel',
  // Keep legacy aliases readable if older rows still exist.
  FILING: 'gavel',
  CORRESPONDENCE: 'mail',
  MEMO: 'sticky_note_2',
  REPORT: 'analytics',
...
const DOC_TYPE_COLORS: Record<string, string> = {
  ...
  COURT_FILING: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300',
  ...
  MEMO: 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300',
