...
import { CASE_SETTINGS_ITEMS } from '@/components/sidebar/configs/cases';

interface CaseSettingsSidebarNavProps {
  isExpanded: boolean;
}

/**
 * Renders the settings items inline in the sidebar when on a case settings page.
 * Case Views & Priority sections are rendered natively by the sidebar via `sections`.
 */
export function CaseSettingsSidebarNav({
  isExpanded: sidebarExpanded,
}: Readonly<CaseSettingsSidebarNavProps>) {
