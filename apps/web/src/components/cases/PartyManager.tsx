          ...
          {parties.map((party) => (
            <li key={party.id} className="flex items-start gap-3 p-3 border rounded-md">
              <div className="flex-1 min-w-0">
                ...
                {party.organization && (
                  <p className="text-xs text-muted-foreground">{party.organization}</p>
                )}
                ...
                {party.notes && (
                  <p className="text-xs text-muted-foreground mt-1 italic">{party.notes}</p>
                )}
              </div>
              {!disabled && (
