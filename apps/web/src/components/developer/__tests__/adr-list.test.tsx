...
const mockAdrs: ADRMetadata[] = [
  {
    ...
    filePath: 'docs/architecture/adr/ADR-001-modern-stack.md',
    relatedADRs: ['ADR-002'],
    sprint: '1',
  },
  {
    ...
    filePath: 'docs/architecture/adr/ADR-005-encryption.md',
    relatedADRs: [],
    sprint: '2',
  },
  {
    ...
    filePath: 'docs/architecture/adr/ADR-010-langchain.md',
    relatedADRs: ['ADR-001'],
    sprint: '3',
  },
  {
    ...
    filePath: 'docs/architecture/adr/ADR-015-cicd.md',
    relatedADRs: [],
    sprint: '4',
  },
  {
    ...
    filePath: 'docs/architecture/adr/ADR-020-tenant-isolation.md',
    relatedADRs: ['ADR-005'],
    sprint: '5',
  },
  {
    ...
    filePath: 'docs/architecture/adr/ADR-030-sprint-validation.md',
    relatedADRs: [],
    sprint: '8',
  },
];
