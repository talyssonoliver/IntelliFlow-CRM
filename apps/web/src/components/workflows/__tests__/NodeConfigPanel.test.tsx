...
describe('NodeConfigPanel', () => {
  it('renders action type dropdown (combobox) when node type is action', () => {
    render(
      <NodeConfigPanel {...baseProps} nodeType="action" config={{}} />,
    );
  ...
  it('renders Save button when node type is end', () => {
    render(
      <NodeConfigPanel {...baseProps} nodeType="end" config={{}} />,
    );
  ...
  it('updates instructions text when textarea changes', () => {
    render(
      <NodeConfigPanel
        {...baseProps}
        nodeType="human"
        config={{ timeout: 60, instructions: '' }}
      />,
    );
