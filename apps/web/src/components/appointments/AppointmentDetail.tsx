      ...
      <div className="grid xl:grid-cols-12 gap-6">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <span
                  className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-semibold ${statusConfig.bgColor} ${statusConfig.color}`}
                >
              ...
              <div className="border-t border-slate-200 dark:border-slate-700 pt-4 space-y-2">
                    ...
                    {hasBuffer ? (
                      <>
                        {appointment.bufferMinutesBefore > 0 &&
                          `${appointment.bufferMinutesBefore} min before`}
                        {appointment.bufferMinutesBefore > 0 &&
                          appointment.bufferMinutesAfter > 0 &&
                          ' / '}
                        {appointment.bufferMinutesAfter > 0 &&
                          `${appointment.bufferMinutesAfter} min after`}
                      </>
                    ) : (
                      'None'
                    )}
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium text-primary">
                    {formatReminder(appointment.reminderMinutes)}
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className="xl:col-span-6">
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm min-h-[560px]">
            <div
              className="flex border-b border-slate-200 dark:border-slate-700 px-4 sm:px-6"
              role="tablist"
            >
                      ...
                      <div className="flex items-start gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-semibold text-slate-900 dark:text-slate-100 truncate">
                            {appointment.linkedCases[0].title}
                          </p>
                          <p className="text-xs text-slate-500">
                            {appointment.linkedCases[0].caseNumber
                              ? `${appointment.linkedCases[0].caseNumber} - Linked Case`
                              : 'Linked Case'}
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        <div className="min-w-0">
                          ...
                          {linkedCase.caseNumber && (
                            <p className="text-xs text-slate-500">{linkedCase.caseNumber}</p>
                          )}
                        </div>
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm">
            ...
            {isTerminal && (
              <p className="text-sm text-slate-500">
                No actions available for {statusConfig.label.toLowerCase()} appointments.
              </p>
            )}
          </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">
                    {formatTimelineDate(appointment.createdAt)}
                  </p>
                </div>
              </div>
              ...
              <>
                ...
                <div className="flex justify-end gap-3">
                  <button
                    ...
                    className="rounded-md border border-slate-200 dark:border-slate-700 px-4 py-2 text-sm hover:bg-slate-50 dark:hover:bg-slate-800"
                  >
                    Cancel
                  </button>
                  <button
                    type="button"
                    onClick={() => handleAction(() => onComplete(dialogInput || undefined))}
            ...
            {activeDialog === 'cancel' && (
              <>
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => handleAction(() => onCancel(dialogInput || undefined))}
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleAction(() =>
                        onReschedule(
                          new Date(rescheduleStart),
                          new Date(rescheduleEnd),
