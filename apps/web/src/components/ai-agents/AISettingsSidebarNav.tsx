...
import { AI_SETTINGS_ITEMS } from '@/components/sidebar/configs/agent-approvals';

interface AISettingsSidebarNavProps {
  isExpanded: boolean;
}

/**
 * Renders the AI settings items inline in the sidebar when on a settings page.
 * All AI sections are rendered natively by the sidebar via `sections`.
 */
export function AISettingsSidebarNav({
  isExpanded: sidebarExpanded,
}: Readonly<AISettingsSidebarNavProps>) {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      {/* ── Divider between settings and AI sections ── */}
