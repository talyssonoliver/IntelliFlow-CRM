...
AI Agent retrieval tool that fetches relevant case documents and notes using RAG
(Retrieval Augmented Generation). Enforces tenant/case ACL constraints, includes
citations with source tracing, and applies prompt-injection hardening on
retrieved content.
