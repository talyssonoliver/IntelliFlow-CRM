      ...
      mockPrisma.caseDocument.findMany.mockResolvedValue([
        {
          ...
          updatedAt: now,
          relatedCaseId: null,
          acl: [{ principalType: 'USER', principalId: 'user-1', accessLevel: 'VIEW' }],
        },
      ]);
      ...
      mockPrisma.caseDocument.findMany.mockResolvedValue([
        {
          ...
          acl: [{ principalType: 'ROLE', principalId: 'LEGAL', accessLevel: 'EDIT' }],
        },
      ]);
      ...
      mockPrisma.caseDocument.findMany.mockResolvedValue([
        {
          ...
          versionMinor: 0,
          versionPatch: 0,
          createdBy: 'user-1', // Creator is the searching user
          createdAt: now,
          updatedAt: now,
          relatedCaseId: null,
          acl: [], // Empty ACL
      ...
      mockPrisma.caseDocument.findMany.mockResolvedValue([
        {
          ...
          versionMinor: 0,
          versionPatch: 0,
          createdBy: 'user-other', // Different creator
          createdAt: now,
          updatedAt: now,
          relatedCaseId: null,
          acl: [{ principalType: 'USER', principalId: 'user-other', accessLevel: 'ADMIN' }], // ACL for different user
        },
      ]);
      ...
      mockPrisma.caseDocument.findMany.mockResolvedValue([
        {
          ...
          updatedAt: now,
          relatedCaseId: null,
          acl: [{ principalType: 'TENANT', principalId: 'tenant-1', accessLevel: 'VIEW' }],
        },
      ]);
