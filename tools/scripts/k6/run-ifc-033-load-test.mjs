...
// NOTE: the HTML report (artifacts/reports/load-test-report.html) is written by the
// script's handleSummary() as a self-contained, script-free static page — NOT the
// k6 web dashboard (K6_WEB_DASHBOARD), whose minified/vendored JS trips static
// analysis. handleSummary renders the real run's metrics + verbatim k6 summary.
