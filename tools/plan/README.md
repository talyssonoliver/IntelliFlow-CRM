...
- [ADR-012: CSV as Source of Truth](../../docs/architecture/adr/ADR-012-csv-source-of-truth.md)
- [ADR-013: Sprint-Scoped Validation](../../docs/architecture/adr/ADR-013-sprint-scoped-validation.md)
